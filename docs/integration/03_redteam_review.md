...
| RT-18 | Contract | MEDIUM | CONFIRM | Two-gate human count unspecified (`02 §3` step 6 NEW GAP; `02 §9`): plan-gate **and** deliverable-gate = two approvals or one fused review? Affects UX and whether the plan envelope is re-confirmed. | `ADR-011`/`capability-manifest` | Human decision; record it. |
...
RT-18 (two-gate human count) · RT-24 (Logix Echo SDK / gh-aw license) · CR-08 (graph topology). The
review's job here is to verify these remain flagged, not to re-resolve them.
